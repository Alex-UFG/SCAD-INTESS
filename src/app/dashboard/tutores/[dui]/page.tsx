    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white dark:bg-gray-900 shadow rounded-lg border border-gray-200 dark:border-gray-800 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400">{t('dui')}</p>
          ...
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400">{t('telefonoPrincipal')}</p>
            <p className="font-medium text-gray-900 dark:text-gray-200">{tutor.telefono_principal}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400">{t('telefonoAlterno')}</p>
          ...
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400">{t('ocupacion')}</p>
